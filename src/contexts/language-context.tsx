...
const translations = {
  'en': {
    ...
    'home.subtitle': 'Senior Software Engineer',
    'home.description': '5+ years building production web applications. Apple Swift Student Challenge 2026 Winner. Built and operated an e-commerce platform generating $90K+ in online sales. I ship scalable React/Next.js frontends, robust Node.js APIs, Swift/SwiftUI mobile apps, and revenue-driving Shopify integrations.',
    ...
    'home.cta.desc': 'Looking for a Software Engineer who understands both code and business? Let\'s talk.',
    'home.skills.title': 'Core Technologies',
    'home.skills.subtitle': 'Technologies I use to build production-ready web applications, mobile apps, and e-commerce platforms',
    'home.connect.title': "Let's Connect",
    'home.connect.subtitle': 'Open to remote opportunities as a Senior Software Engineer',
    ...
    'about.summary.paragraph1': "I'm a Full Stack Software Engineer with 5+ years of hands-on experience building and operating production-grade web applications and revenue-generating digital platforms, including a profitable e-commerce business with over US$90,000 in total sales.",
    'about.summary.paragraph2': 'I specialize in designing scalable, high-performance frontend architectures and robust backend services, delivering custom business logic for e-commerce platforms, SaaS products, and internal systems. Recently, I expanded into the Apple native ecosystem, culminating in being selected as a global winner of the Apple Swift Student Challenge 2026.',
    'about.summary.paragraph3': "I've worked in international, fully remote environments, collaborating with cross-functional teams and taking full ownership of features end-to-end — from system design and implementation to production deployment and continuous optimization.",
    ...
    'footer.subtitle': 'Senior Software Engineer',
  ...
  'pt-BR': {
    ...
    'home.subtitle': 'Engenheiro de Software Sênior',
    'home.description': '5+ anos construindo aplicações web de produção. Vencedor do Apple Swift Student Challenge 2026. Construí e operei uma plataforma de e-commerce gerando $90K+ em vendas online. Entrego frontends React/Next.js escaláveis, APIs Node.js robustas, apps Swift/SwiftUI e integrações Shopify que geram receita.',
    ...
    'home.cta.desc': 'Procurando um Engenheiro de Software que entende código e negócios? Vamos conversar.',
    'home.skills.title': 'Tecnologias Principais',
    'home.skills.subtitle': 'Tecnologias que uso para construir aplicações web, apps mobile e plataformas e-commerce prontas para produção',
    'home.connect.title': 'Vamos Conectar',
    'home.connect.subtitle': 'Aberto a oportunidades remotas como Engenheiro de Software Sênior',

    // About page
    'about.title': 'Engenheiro de Software Sênior',
    ...
    'about.summary.paragraph1': 'Sou um Engenheiro de Software Full Stack com 5+ anos de experiência prática construindo e operando aplicações web de produção e plataformas digitais geradoras de receita, incluindo um negócio de e-commerce lucrativo com mais de US$90.000 em vendas totais.',
    'about.summary.paragraph2': 'Me especializo em projetar arquiteturas frontend escaláveis e de alta performance e serviços backend robustos, entregando lógica de negócio customizada para plataformas e-commerce, produtos SaaS e sistemas internos. Recentemente, expandi para o ecossistema nativo Apple, culminando em ser selecionado como vencedor global do Apple Swift Student Challenge 2026.',
    'about.summary.paragraph3': 'Trabalhei em ambientes internacionais, totalmente remotos, colaborando com equipes multifuncionais e assumindo ownership completo de features de ponta a ponta — do design de sistema e implementação até deployment em produção e otimização contínua.',
    ...
    // Footer
    'footer.title': 'Matheus Abrahão',
    'footer.subtitle': 'Engenheiro de Software Sênior',
